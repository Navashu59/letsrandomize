...
- 2026-06-02: Completed remaining topical authority structure work: added `/decision-tools/` and `/generators/` hub pages, linked them from homepage/tools/guides/use-cases, updated sitemap to 65 URLs, and synced topical/keyword maps plus pending task status.
